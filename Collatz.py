...
def collatz_eval(i, j):
    ...
    while (current *1000 < j):
	    if (beginning):
	    	maxCycle = interval_eval(i ,current * 1000)
	    ...
	    if (j > current*1000+1000):
	    	...
	    	#print ("Current is", current)
	    if (j <= current * 1000 + 1000):
	    	end_interval_maxCycle = interval_eval(current,j)
...
'''
output_file = open("ammar_RunCollatz.out", "r")
