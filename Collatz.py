...
"""
this cache has the max cycle length for every interval in the thousands.
Begins from 1-1000, then 1001-2000, and so on
"""
...
def interval_eval(i, j):
    """
    helper function that computes the max cycle length of a given interval, inclusive
    """
    maxCycle = 1
...
def compute_cycle_length(n):  # Helper function
    """
    helper function for interval_eval(which is also a helper function)
    it simply computes cycle length for a given positive integer
    """
    cycle = 1
